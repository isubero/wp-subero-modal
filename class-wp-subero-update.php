<?php
/**
 * WP Subero Autoupdate
 *
 * Handles plugin auto-updates.
 * @version 1.0
 */

class WP_Subero_Autoupdate {
	...
	public function __construct( $product_name, $current_version, $update_path, $plugin_slug, $license_user = '', $license_key = '' ) {
